...
import com.zelix.yikondi.service.YikondiAppKafkaProducer;
import com.zelix.yikondi.service.YikondiAppKafkaConsumer;
...
public class YikondiAppKafkaResourceIT {
    ...
    @Autowired
    private YikondiAppKafkaProducer producer;

    @Autowired
    private YikondiAppKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        YikondiAppKafkaResource kafkaResource = new YikondiAppKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/yikondi-app-kafka/publish?message=test"))
